...
-- function da Q4: fn_relatorio_doacoes_filtro

CREATE OR REPLACE FUNCTION fn_relatorio_doacoes_filtro(
    p_id_plataforma INT DEFAULT NULL,
...
-- function da Q5: fn_relatorio_patrocinio

CREATE OR REPLACE FUNCTION fn_relatorio_patrocinio(
    p_id_plataforma INT DEFAULT NULL,
...
-- function da Q6: fn_relatorio_inscricoes

CREATE OR REPLACE FUNCTION fn_relatorio_inscricoes(
    p_id_plataforma INT DEFAULT NULL,
    p_nome_canal VARCHAR(50) DEFAULT NULL,
    p_valor_minimo NUMERIC DEFAULT 0
)
...
CREATE OR REPLACE FUNCTION fn_relatorio_total_doacoes_canal(
    p_id_plataforma INT DEFAULT NULL,
    p_nome_canal VARCHAR(50) DEFAULT NULL,
    p_valor_minimo NUMERIC DEFAULT 0
)
...
CREATE OR REPLACE FUNCTION fn_relatorio_faturamento_total(
    p_id_plataforma INT DEFAULT NULL,
    p_nome_canal VARCHAR(50) DEFAULT NULL,
    p_valor_minimo NUMERIC DEFAULT 0
)
